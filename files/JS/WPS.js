...
Surge4 or Loon:
[Script]
http-response ^https?:\/\/[a-z-]*account\.wps\.c(n|om)(:\d+|)\/api\/users requires-body=1,max-size=-1,script-path=https://raw.githubusercontent.com/TYC2021/selfuse/main/files/JS/WPS.js
[MITM]
hostname = *account.wps.cn, *account.wps.com
**************************/
